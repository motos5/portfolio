<section class="peak" style="background: url('<?php the_field('peak_bg', 'option'); ?>'); background-repeat: no-repeat; background-position: right top; background-size: 50%; background-color: #fff;">
    <div class="container">
        <div class="peak__inner">
            <h2 class="title peak__title">ПОКОРЯЙ ВЕРШИНЫ</h2>
