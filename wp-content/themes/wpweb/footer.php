        ...
        <div class="footer__inner">
            <div class="footer__left">
                <h2 class="title footer__left-title">
                    For cooperation or clarification of details
                </h2>
                ...
                <form class="form footer__form">
                    ...
                    <textarea class="form__textarea" placeholder="Enter your suggestion or question"></textarea>
                    <button class="btn form__button" type="submit">Send a message</button>
                </form>
            </div>
            <div class="footer__right">
                ...
                <div class="email__box">
                    <p class="email__lable">Email</p>
                    <a class="email__link" href="mailto:allmarket198@gmail.com">allmarket198@gmail.com</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="popup__inner">
            <div class="popup__content">
                <div class="popup__content-top">
                    <h3 class="title popup__content-title">Let's talk. Write a message.</h3>
                    <a class="close popup__content-close" href="#">
                ...
                <form class="form popup__content-form">
                    <input class="form__input" type="text" placeholder="Enter your name">
                    <input class="form__input" type="email" placeholder="Enter your email">
                    <textarea class="form__textarea" placeholder="Enter your suggestion or question"></textarea>
                    <button class="btn form__button" type="submit">Send a message</button>
