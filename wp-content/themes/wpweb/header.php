		...
		<div class="header__top">
			<div class="container">
				<div class="header__top-inner">
					...
					$socials_btn = '<ul class="socials__list">
										<li class="socials__item">
											<a class="socials__link" href="https://www.facebook.com/vitaliy.izotov" target="_blank">
										...
										<li class="socials__item">
											<a class="socials__link" href="https://www.instagram.com/izotov_vitalii/" target="_blank">
										...
										<li class="socials__item">
											<a class="socials__link" href="https://www.linkedin.com/in/vitaliy-izotov/" target="_blank">
												<svg xmlns="http://www.w3.org/2000/svg" width="52" height="52" fill="none">
										...
										<li class="socials__item">
											<a class="socials__link" href="https://t.me/vitaliy_izotov" target="_blank">
												<svg xmlns="http://www.w3.org/2000/svg" width="52" height="52" fill="none">
										...
										<li class="socials__item">
											<a class="socials__link" href="https://join.skype.com/invite/KZpOWHl1eKWY" target="_blank">
												<svg xmlns="http://www.w3.org/2000/svg" width="52" height="52" fill="none">
						...
						wp_nav_menu( [
							...
							'menu_id'         => false,
							'echo'            => true,
							'items_wrap'      => '<ul id="%1$s" class="%2$s">%3$s</ul> <div class="header__menu-buttons">' . $socials_btn . $talk_btn . '</div>',
						] );
					?>
				</div>
			</div>
			...
			<div class="container">
				<div class="header__content-inner">
					...
					<div class="header__buttons">
						<a class="btn header__content-btn see" href="#works">See Works</a>
